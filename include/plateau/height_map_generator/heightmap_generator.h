...
namespace plateau::heightMapGenerator {
    ...
    public:
        ...
        HeightMapWithAlpha generateFromMeshAndTriangles(const plateau::polygonMesh::Mesh& in_mesh, size_t texture_width, size_t texture_height, bool fillEdges, TriangleList& triangles);
