...
void PlateauDllLogger::log(CityGMLLogger::LOGLEVEL level,
                           const std::string& message, const char* file, int line) const {
...
void PlateauDllLogger::setLogCallbacks(LogCallbackFuncPtr error_callback, LogCallbackFuncPtr warn_callback,
