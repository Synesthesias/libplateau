...
namespace plateau::polygonMesh {
    ...
    private:
         ...
         */
        static void
        mergeWithoutTexture(Mesh& mesh, const citygml::Polygon& other_poly, const TVec2f& uv_2_element,
                            const TVec2f& uv_3_element, const MeshExtractOptions& options);

        /// 形状情報をマージします。merge関数における SubMesh を扱わない版です。
        static void
        mergeShape(Mesh& mesh, const citygml::Polygon& other_poly, const TVec2f& uv_2_element,
                   const TVec2f& uv_3_element,
