...
//        Client client = Client();
    ...
    TEST_F(ClientTest, Download) { // NOLINT
        ...
        auto fpath_str = Client::createClientForMockServer().download(u8".", Client::getDefaultServerUrl() + u8"/13100_tokyo23-ku_2020_citygml_3_2_op/udx/bldg/53392642_bldg_6697_2_op.gml");
